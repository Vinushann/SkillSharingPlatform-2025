...
public class CommentController {
    ...
    public ResponseEntity<CommentDTOs.CommentResponse> createComment(
        ...
        CommentDTOs.CommentResponse response = commentService.createComment(request.getPostId(), request.getContent(),
                currentUser);
    ...
    public ResponseEntity<CommentDTOs.CommentResponse> updateComment(
            ...
            @PathVariable String userId) {
        AppUser currentUser = userRepository.getById(userId);
        CommentDTOs.CommentResponse response = commentService.updateComment(commentId, request.getContent(),
                currentUser);
        return ResponseEntity.ok(response);
    }
