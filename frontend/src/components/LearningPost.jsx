...
import learningPlans from "./LearningHomeComponent/learningPlans"; // Import the learning plans data
...
const LearningPost = () => {
  ...
  const posts = learningPlans.map((plan, index) => ({
    ...
    subtopics: plan.subtopics.map((sub) => ({
      ...sub,
      completed: Math.random() > 0.5,
    })), // Randomly mark subtopics as completed
    ...
    >
      ...
      {posts.map((post) => (
        ...
        >
                ...
                <ListItemIcon>
                  <Box
                    sx={{
                      ...
                      height: 12,
                      borderRadius: "50%",
                      bgcolor: subtopic.completed ? "green" : "black",
                    }}
                  />
                </ListItemIcon>
          ...
          {/* Share Dialog */}
          <Dialog
            open={postStates[post.id]?.shareDialogOpen}
            onClose={() => handleShareDialogClose(post.id)}
          >
            ...
            <DialogActions>
              ...
              <Button
                onClick={() => handleShareDialogClose(post.id)}
                sx={{ color: "#ef5350" }}
              >
                Close
              </Button>
          ...
          {/* More Details Dialog */}
          <Dialog
            open={postStates[post.id]?.moreDialogOpen}
            onClose={() => handleMoreDialogClose(post.id)}
          >
            ...
            <DialogActions>
              <Button
                onClick={() => handleMoreDialogClose(post.id)}
                sx={{ color: "#ef5350" }}
              >
                Close
              </Button>
