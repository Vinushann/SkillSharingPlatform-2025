  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-white flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-xl sm:rounded-xl sm:px-10 border border-purple-100">
          {error && (
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                type="button"
                className="w-full inline-flex justify-center py-3 px-4 border border-purple-200 rounded-xl shadow-md bg-white text-sm font-medium text-gray-700 hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all"
              >
                <svg
                  className="w-5 h-5"
                  aria-hidden="true"
